    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{ route('product/subaddcategory') }}" class="btn btn-added">
                        <img src="{{ asset('assets/img/icons/plus.svg') }}" class="me-2" alt="img"> Add Sub Category
                    </a>
                </div>
            </div>
                        ...
                        <table class="table datanew">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="product-img">
                                            <img src="{{ asset('assets/img/product/product10.jpg') }}" alt="product">
                                        </a>
                                    </td>
                                    <td>Health Care </td>
                                    <td>Health Care </td>
