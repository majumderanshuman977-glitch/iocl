    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{ route('user.superadmin.create') }}" class="btn btn-added">
                        <img src="{{ asset('assets/img/icons/plus.svg') }}" alt="img" class="me-2">Add Super Admin
                    </a>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ route('user.superadmin') }}">
                        <div class="row">
                            ...
                            <tbody>
                                @foreach ($user as $u)
                                    <tr id="user-row-{{ $u->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('user.superadmin.edit', $u->id) }}"
