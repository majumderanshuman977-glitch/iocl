                        ...
                        <table class="table  datanew">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="{{ asset('assets/img/customer/customer2.jpg') }}" alt="product">
                                        </a>
                                    </td>
                                    <td>Benjamin</td>
                                    <td>Franklin </td>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="{{ asset('assets/img/customer/customer3.jpg') }}" alt="product">
                                        </a>
                                    </td>
                                    <td>James</td>
                                    <td>James </td>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="{{ asset('assets/img/customer/customer4.jpg') }}" alt="product">
                                        </a>
                                    </td>
                                    <td>Bruklin</td>
                                    <td>Bruklin </td>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="{{ asset('assets/img/customer/customer5.jpg') }}" alt="product">
                                        </a>
                                    </td>
                                    <td>Franklin</td>
                                    <td>Jacob </td>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="{{ asset('assets/img/customer/customer6.jpg') }}" alt="product">
                                        </a>
                                    </td>
                                    <td>B. Huber </td>
                                    <td>Jacob </td>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="{{ asset('assets/img/customer/customer7.jpg') }}" alt="product">
                                        </a>
                                    </td>
                                    <td>Alwin</td>
                                    <td>Alwin </td>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="{{ asset('assets/img/customer/customer8.jpg') }}" alt="product">
                                        </a>
                                    </td>
                                    <td>Fred john</td>
                                    <td>john </td>
                                ...
                                <tr>
                                    ...
                                    <td>+12163547758 </td>
                                    <td>
                                        <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="702211031d050303151e301508111d001c155e131f1d">[email&#160;protected]</a>
                                    </td>
                                    <td>
                                        <div
                                            class="status-toggle d-flex justify-content-between align-items-center">
