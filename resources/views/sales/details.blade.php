                            ...
                            <tbody>
                                                        ...
                                                        <font style="vertical-align: inherit;">
                                                            <font
                                                                ...
                                                                <a href="/cdn-cgi/l/email-protection"
                                                                    class="__cf_email__"
                                                                    data-cfemail="3a4d5b565117535417594f494e55575f487a5f425b574a565f14595557">[email&#160;protected]</a>
                                                            </font>
                                                        </font><br>
                                                        <font style="vertical-align: inherit;">
                                                            <font
                                ...
                                <tr class="details" style="border-bottom:1px solid #E9ECEF ;">
                                    <td
                                        ...
                                        <img src="{{ asset('assets/img/product/product1.jpg') }}" alt="img" class="me-2"
                                ...
                                <tr class="details" style="border-bottom:1px solid #E9ECEF ;">
                                    <td
                                        style="padding: 10px;vertical-align: top; display: flex;align-items: center;">
                                        <img src="{{ asset('assets/img/product/product7.jpg') }}" alt="img" class="me-2"
                                            style="width:40px;height:40px;">
                                        Apple Earpods
                                    </td>
                                    <td style="padding: 10px;vertical-align: top; ">
                                ...
                                <tr class="details" style="border-bottom:1px solid #E9ECEF ;">
                                    <td
                                        style="padding: 10px;vertical-align: top; display: flex;align-items: center;">
                                        <img src="{{ asset('assets/img/product/product8.jpg') }}" alt="img" class="me-2" style="width:40px;height:40px;">
                                        samsung
                                    </td>
                                    <td style="padding: 10px;vertical-align: top; ">
                                        1.00
