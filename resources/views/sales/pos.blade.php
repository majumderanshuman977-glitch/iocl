                        ...
                        <div class="row ">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill active">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product29.jpg') }}" alt="img">
                                        <h6>Qty: 5.00</h6>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product31.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product35.jpg') }}" alt="img">
                                        <h6>Qty: 5.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product37.jpg') }}" alt="img">
                                        <h6>Qty: 5.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product54.jpg') }}" alt="img">
                                        <h6>Qty: 5.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                    ...
                    <div class="tab_content" data-tab="headphone">
                        <div class="row ">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product44.jpg') }}" alt="img">
                                        <h6>Qty: 5.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product45.jpg') }}" alt="img">
                                        <h6>Qty: 5.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product36.jpg') }}" alt="img">
                                        <h6>Qty: 5.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                    ...
                    <div class="tab_content" data-tab="Accessories">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product32.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product46.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product55.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                    ...
                    <div class="tab_content" data-tab="Shoes">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product60.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                    ...
                    <div class="tab_content" data-tab="computer">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product56.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                    ...
                    <div class="tab_content" data-tab="Snacks">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product47.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product48.png') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product57.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product58.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                    ...
                    <div class="tab_content" data-tab="watch">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product49.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product51.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                    </div>
                                    <div class="productsetcontent">
                                        <h4>Watch</h4>
                    ...
                    <div class="tab_content" data-tab="cycle">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product52.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill">
                                    <div class="productsetimg">
                                        <img src="{{ asset('assets/img/product/product53.jpg') }}" alt="img">
                                        <h6>Qty: 1.00</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
                        ...
                        <div class="product-table">
                            <ul class="product-lists">
                                ...
                                <li><a class="confirm-text" href="javascript:void(0);"><img
                                            src="{{ asset('assets/img/icons/delete-2.svg') }}" alt="img"></a></li>
                            </ul>
                            <ul class="product-lists">
                                <li>
                                    <div class="productimg">
                                        <div class="productimgs">
                                            <img src="{{ asset('assets/img/product/product34.jpg') }}" alt="img">
                                        </div>
                                        <div class="productcontet">
                                            <h4>Green Nike
                                                <a href="javascript:void(0);" class="ms-2" data-bs-toggle="modal"
                            ...
                            <ul>
                                <li>
                                    <a href="javascript:void(0);" class="paymentmethod">
                                        <img src="{{ asset('assets/img/icons/cash.svg') }}" alt="img" class="me-2">
                                        Cash
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="paymentmethod">
                                        <img src="{{ asset('assets/img/icons/debitcard.svg') }}" alt="img" class="me-2">
                                        Debit
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="paymentmethod">
                                        <img src="{{ asset('assets/img/icons/scan.svg') }}" alt="img" class="me-2">
                                        Scan
                                    </a>
                                </li>
                            </ul>
                    ...
                    <ul class="nav nav-tabs" id="myTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="payment-tab" data-bs-toggle="tab" data-bs-target="#payment"
                                type="button" aria-controls="payment" aria-selected="false" role="tab">Payment</button>
                        </li>
                        <li class="nav-item" role="presentation">
